<?php
namespace T3v\T3vStage\Tests\Functional;
 ...
 *
 * @package T3v\T3vStage\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
   ...
   * @var array
   */
  protected $testExtensionsToLoad = ['typo3conf/ext/t3v_stage'];
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Stage</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_stage/Tests/Functional/Fixtures/Frontend/Basic.ts']);
  }
